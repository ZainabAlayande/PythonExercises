...
def add_the_double_digit_from_behind():  # 37
    sum_it = 0
    for i in new_lst:
        sum_it = sum_it + i
...
def check_if_card_is_invalid():
    response_one = (add_the_double_digit_from_behind() + add_digit_in_the_odd_places()) % 10 == 0
    response_two = (add_the_double_digit_from_behind() + add_digit_in_the_odd_places()) % 10 != 0
